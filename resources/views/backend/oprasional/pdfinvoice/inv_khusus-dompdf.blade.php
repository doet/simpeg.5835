...
<html>
    ...
    <body style="font-size:12px;">
        ...
        <main>
            <div style="page-break-after: avoid;">
              ...
              <table>
                  <tr tr style="font-size:11px; font-weight: bold;">
                    ...
                    <td class="top right" colspan="4" style="background-color: #DCDCDC;">&nbsp;Berdasarkan / <i>Base on :</i></td>
                  ...
                  <tr>
                    ...
                    <td class="top right" width="300px">&nbsp;<?php echo $helperInv['data']['agenName']?></td>
                    <td class="top right" width="80px">&nbsp;PPJ No</td>
                    <td class="top right">&nbsp;<?php echo $helperInv['data']['ppjk'] ?></td>
                    <td class="top right" width="50px">&nbsp;LOA</td>
                    <td class="top right">&nbsp;<?php echo $helperInv['data']['ppjk'] ?></td>
                  ...
                  <tr>
                    <td class="left top right button" rowspan="2">&nbsp;Alamat / <i>Address</i></td>
                    <td class="top right button" rowspan="2">&nbsp;<?php echo $helperInv['data']['agenAlamat'] .' '. $helperInv['data']['agenTlp'];?></td>
                    <td class="top right">&nbsp;BASTDO No</td>
                    <td class="top right">&nbsp;<?php echo $helperInv['data']['refno']?></td>
                    <td class="top right">&nbsp;DWT</td>
                    <td class="top right">&nbsp;<?php echo $helperInv['data']['refno']?></td>
                  ...
                  <tr>
                    ...
                    <td class="top right button" colspan="3">&nbsp;<?php if (count($helperInv['data']['code'])>1) echo 'Cilegon/Serang'; else echo $helperInv['data']['code'][0]; ?></td>
                    <td class="top right button">&nbsp;Bendera / Flag</td>
                    <td class="top right button">&nbsp;<?php echo $helperInv['data']['kapalsBendera']?></td>
                  </tr>
              </table>
              ...
              <table style="font-size:11px;">
                <thead>
                  <tr>
                    <!-- rowspan="2" colspan="2" -->
                    <td class="left top right" rowspan="3" width='55px'>BAPP<br>No</td>
              ...
              <?php
                ...
                foreach ($helperInv['isi'] as $row) {
                  ...
                  echo '<tr>';
                  echo '<td class="left top right" align="center"> '.$row['bapp'].' </td>';
            ...
            <div style="position:absolute; top:70; left:650; width:300; font-size:11px;">
              <?php
              // dd($helperInv);
              if($helperInv['data']['rute']  == '$') {
