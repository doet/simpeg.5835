...
<script type="text/javascript">
  jQuery(function($) {
    ...
    var master = jQuery(tabel).jqGrid({
      ...
      mtype : "post",
			postData: {datatb:'mdermaga',_token:'{{ csrf_token() }}'},
      ...
      colModel:[
        {name:'myac',index:'', width:50, fixed:true, sortable:false, resize:false,
          ...
          // }
				...
				{name:'code',index:'code', width:50, editable: true, align: 'center'},
    ...
    jQuery(tabel).jqGrid('navGrid',pager_tabel, {   //navbar options
      ...
      onclickSubmit: function () {
        return { datatb:'mdermaga', _token:'<?php echo csrf_token();?>'};
      }
    },{
      //new record form
      //width: 700,
