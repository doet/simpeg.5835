...
<script type="text/javascript">
  jQuery(function($) {
    ...
    var master = jQuery(tabel).jqGrid({
      ...
      editurl: "{{url('api/kepegawaian/cud')}}",//nothing is saved
      ...
      //   return postdata;
      // },
      postData: {datatb:'dtkeluarga',id_u:'{{$e}}', _token:'{{ csrf_token() }}'},
      sortname:'dob',
      sortorder: 'desc',
      height: 250,
      colNames:[' ', 'Nama', 'Hub','L/P','Tgl. Lahir', 'Agama'],
      colModel:[
        ...
        {name:'hub',index:'hub', width:90, editable: true,edittype:"select",editoptions:{value:"istri:Istri;suami:Suami;anak:Anak"}},
        {name:'jk',index:'jk', width:90, editable: true,edittype:"select",editoptions:{value:"L:Lelaki;P:Perempuan"}},
        {name:'dob',index:'dob', width:90, editable: true, sorttype:"date",unformat: pickDate},
        {name:'agama',index:'agama', width:90, editable: true,edittype:"select",editoptions:{value:"Islam:Islam;Kristen:Kristen;Hindu:Hindu;Budha:Budha"}},
      ],
    ...
    jQuery(tabel).jqGrid('navGrid',pager_tabel, {   //navbar options
      ...
      onclickSubmit: function () {
        return { datatb:'dtkeluarga', id_u:'{{$e}}',_token:'<?php echo csrf_token();?>'};
      }
    },{
      //new record form
      //width: 700,
