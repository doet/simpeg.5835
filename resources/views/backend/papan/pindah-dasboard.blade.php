...
<script type="text/javascript">
  ...
  jQuery(function($) {
    ...
    var i = 0;
    var restore;
    interact('.drag-elm').draggable({
        autoScroll: true,
        onstart: function (event) {
          var target = event.target;
          restore = target.innerHTML;
          //
          console.log(restore);
        },
        onmove: function (event) {
          var target = event.target;
          target.innerHTML = '<td><div class="dropzone">drag</div></td>';
          // keep the dragged position in the data-x/data-y attributes
          ...
          // $new.addClass(target.classList.value);
          // $('tr').find('.drag-active').html('<td></td>');

// $box[0].classList.value;
          // target.css({
          //     minHeight: 80,
          //     display: 'flex',
          //     alignItems: 'center'
          ...
          // var $new = $('<div class="ini-active"></div>');
          // $new.css({
          //     minHeight: 80,
          //     display: 'flex',
          //     alignItems: 'center'
