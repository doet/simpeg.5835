...
@section('content')
    ...
    <!-- 01 Header Form-->
            ...
            <!-- 02 body Form -->
                        <div class="modal-body">
                          ...
                          {{ csrf_field() }}
                          <input type="hidden" id="datatb" name="datatb" value="koperasi" />
                          <input type="hidden" id="id" name="id" />
                          <input type="hidden" id="setdate" name="setdate" />

                          <div class="form-group">
                              <label class="control-label col-xs-12 col-sm-3 no-padding-right" for="name">Simpanan Pokok :</label>
                              <div class="col-xs-12 col-sm-9">
                                  <div class="clearfix"><input type="text" id="pokok" name="koperasi['pokok']" value="" class="col-xs-12 col-sm-5" onkeyup="formatNumber(this);" onchange="formatNumber(this);"/></div>
                              </div>
                          </div><div class="space-2"></div>
                          <div class="form-group">
                              <label class="control-label col-xs-12 col-sm-3 no-padding-right" for="name">Simpanan Wajib :</label>
                              <div class="col-xs-12 col-sm-9">
                                  <div class="clearfix"><input type="text" id="wajib" name="koperasi['wajib']" value="" class="col-xs-12 col-sm-5" onkeyup="formatNumber(this);" onchange="formatNumber(this);"/></div>
                              </div>
                          </div><div class="space-2"></div>
                          <div class="form-group">
                              <label class="control-label col-xs-12 col-sm-3 no-padding-right" for="name">Simpanan Sukarela :</label>
                              <div class="col-xs-12 col-sm-9">
                                  <div class="clearfix"><input type="text" id="sukarela" name="koperasi['sukarela']" value="" class="col-xs-12 col-sm-5" onkeyup="formatNumber(this);" onchange="formatNumber(this);"/></div>
                              </div>
                          </div><div class="space-2"></div>
                          <div class="form-group">
                              <label class="control-label col-xs-12 col-sm-3 no-padding-right" for="name">MPPA :</label>
                              <div class="col-xs-12 col-sm-9">
                                  <div class="clearfix"><input type="text" id="mppa" name="koperasi['mppa']" value="" class="col-xs-12 col-sm-5" onkeyup="formatNumber(this);" onchange="formatNumber(this);"/></div>
                              </div>
                          </div><div class="space-2"></div>
                          <div class="form-group">
                              <label class="control-label col-xs-12 col-sm-3 no-padding-right" for="name">Emergency Loan :</label>
                              <div class="col-xs-12 col-sm-9">
                                  <div class="clearfix"><input type="text" id="loan" name="koperasi['el']" value="" class="col-xs-12 col-sm-5" onkeyup="formatNumber(this);" onchange="formatNumber(this);"/></div>
                              </div>
                          </div><div class="space-2"></div>
                        </div>
    <!-- 02 end body Form -->
    ...
    <!-- end Form -->
    <div align="center">Data Koperasi<br />PT. PELABUHAN CILEGON MANDIRI<br />
  ...
  jQuery(function($) {
    ...
    var pager_selector = "#grid-pager";
        ...
        jQuery(grid_selector).jqGrid({
            ...
            sortname:'id',
            sortorder: 'asc',
            postData: {datatb:'koperasi', start:start, end:end, _token:'{{ csrf_token() }}'},
            height: 250,
            colNames:['NIK','Nama','Pokok','Wajib','Sukarela','MPPA','Emergency Loan','angsuran','Total Pembayaran'],
            colModel:[
              {name:'nip',index:'nip', width:50, align:'center' },
              {name:'nama',index:'nama', width:100  },
              {name:'pokok',index:'pokok', width:60, sortable:false, editable: true, align: 'right', formatter: 'number',
                  formatoptions: { thousandsSeparator: ",", decimalPlaces: 0, defaultValue: '0' }
              },
              {name:'wajib',index:'wajib', width:60, sortable:false, editable: true, align: 'right', formatter: 'number',
                  formatoptions: { thousandsSeparator: ",", decimalPlaces: 0, defaultValue: '0' }
              },
              {name:'sukarela',index:'sukarela', width:60, sortable:false, editable: true, align: 'right', formatter: 'number',
                  formatoptions: { thousandsSeparator: ",", decimalPlaces: 0, defaultValue: '0' }
              },
              {name:'mppa',index:'mppa', width:60, sortable:false, editable: true, align: 'right', formatter: 'number',
                  formatoptions: { thousandsSeparator: ",", decimalPlaces: 0, defaultValue: '0' }
              },
              {name:'loan',index:'loan', width:60, sortable:false, editable: true, align: 'right', formatter: 'number',
                  formatoptions: { thousandsSeparator: ",", decimalPlaces: 0, defaultValue: '0' }
              },
              {name:'a',index:'a', width:60, sortable:false, editable: true, align: 'right', formatter: 'number',
                  formatoptions: { thousandsSeparator: ",", decimalPlaces: 0, defaultValue: '0' }
              },
              {name:'t',index:'t', width:60, sortable:false, editable: true, align: 'right', formatter: 'number',
                  formatoptions: { thousandsSeparator: ",", decimalPlaces: 0, defaultValue: '0' }
              },
          ],
...
//                    alert(JSON.stringify(setdate));
                  ...
                  $('#pokok').val(addCommas($(this).jqGrid ('getCell', gsr, 'pokok')));
                  $('#wajib').val(addCommas($(this).jqGrid ('getCell', gsr, 'wajib')));
                  $('#sukarela').val(addCommas($(this).jqGrid ('getCell', gsr, 'sukarela')));
                  $('#mppa').val(addCommas($(this).jqGrid ('getCell', gsr, 'mppa')));
                  $('#loan').val(addCommas($(this).jqGrid ('getCell', gsr, 'loan')));
