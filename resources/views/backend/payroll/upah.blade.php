  ...
  jQuery(function($) {
    ...
    var pager_selector = "#grid-pager";
        ...
        jQuery(grid_selector).jqGrid({
            ...
            height: 250,
            colNames:['NIP','Nama','Upah Pokok','Honor','Perum','Shift','Jabatan','Pandu','Profesi','B.Kerja','U.Mkn','Tr.port','Lembur','B.Cuti','KBL','Kendaraan','BBM','P.Kendaraan'],
            colModel:[
                ...
                {name:'pandu',index:'pandu', width:70, sortable:false, editable: true, align: 'right', formatter: 'number',
                    formatoptions: { thousandsSeparator: ",", decimalPlaces: 0, defaultValue: '0' }
                },
