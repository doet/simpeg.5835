    ...
    jQuery(function($) {
        ...
        if(!ace.vars['touch']) {
            ...
            jQuery(grid_selector).jqGrid({
                ...
                sortname:'id',
                height: 250,
                colNames:['nip','nama','Jabatan','Divisi','Lokasi','tglK' ],
                colModel:[
                    {name:'nip',index:'nip', width:50},
                    {name:'nama',index:'nama',width:100, editable:true},
                    {name:'lb1',index:'lb1', width:100,editable: true},
                    {name:'lb2',index:'lb2', width:100,editable: true},
                    {name:'wkerja',index:'wkerja', width:150,editable: true},
