        ...
        <div class="col-xs-12">
            ...
            <div class="container-fluid">
              <div class="row">
                ...
                <div class="col-sm-6 col-md-8" style="border: 0.5px solid black">
                  <div class="row" style="border: 0.5px solid white">
                    <div class="col-xs-2 col-sm-3 col-md-2 produk"><span>Makanan</span></div>
                    <div class="col-xs-2 col-sm-3 col-md-2 produk"><span>Minuman</span></div>
                    <div class="col-xs-2 col-sm-3 col-md-2 produk"><span>Paket</span></div>
                    <div class="col-xs-2 col-sm-3 col-md-2 produk"><span>lain-lain</span></div>
                  </div>
                  <div class="row" style="border: 0.5px solid white">
                    @foreach ($produk as $row)
                    <div class="col-xs-2 col-sm-3 col-md-2 produk"><span>
                      @if ($row->nama_produk == $row->deskripsi)
                        {{$row->nama_produk}}
                      @else
                        {{$row->nama_produk}}</br>
                        <font class="deskripsi">{{$row->deskripsi}}<font>
                      @endif
                    </span></div>
                    @endforeach
                  </div>
