...
<table>
  <tr>
		<td width="550px" align="center">&nbsp;</td>
...
<table >
  ...
  <tr>
    <td width="25px" align="center">&nbsp;</td>
    <td width="100px" class="left" colspan="2"><img src="{{public_path().'\\pic\\nonchkbox.png'}}" alt="" width="15px" />1. Perjanjian Kerja</td>
    <td width="200px" class="" colspan="3">No; </td>
    <td width="100px" class="" colspan="2"><img src="{{public_path().'\\pic\\nonchkbox.png'}}" alt="" width="15px" />7. Invoice </td>
    <td width="200px" class="right" colspan="3">No;</td>
  </tr>
  <tr>
    <td align="center">&nbsp;</td>
    <td class="left" colspan="2"><img src="{{public_path().'\\pic\\nonchkbox.png'}}" alt="" width="15px" />2. SPK</td>
    <td class="" colspan="3">No;</td>
    <td class="" colspan="2"><img src="{{public_path().'\\pic\\nonchkbox.png'}}" alt="" width="15px" />8.Kwitansi</td>
    <td class="right" colspan="3">No;</td>
  </tr>
  <tr>
    <td align="center">&nbsp;</td>
    <td class="left" colspan="2"><img src="{{public_path().'\\pic\\nonchkbox.png'}}" alt="" width="15px" />3. BAST Pekerjaan</td>
    <td class="" colspan="3">No;</td>
    <td class="" colspan="2"><img src="{{public_path().'\\pic\\nonchkbox.png'}}" alt="" width="15px" />9. Faktur Pajak</td>
    <td class="right" colspan="3">No;</td>
  </tr>
  <tr>
    <td align="center">&nbsp;</td>
    <td class="left" colspan="2"><img src="{{public_path().'\\pic\\nonchkbox.png'}}" alt="" width="15px" />4. SK Direktur</td>
    <td class="" colspan="3">No;</td>
    <td class="" colspan="2"><img src="{{public_path().'\\pic\\nonchkbox.png'}}" alt="" width="15px" />10. Lainnya:</td>
    <td class="right" colspan="3">No;</td>
  </tr>
  <tr>
    <td align="center">&nbsp;</td>
    <td class="left" colspan="2"><img src="{{public_path().'\\pic\\nonchkbox.png'}}" alt="" width="15px" />5. Internal Memo</td>
    <td class="" colspan="3">No;</td>
  ...
  <tr>
    <td align="center">&nbsp;</td>
    <td class="left" colspan="2"><img src="{{public_path().'\\pic\\nonchkbox.png'}}" alt="" width="15px" />6. Lembar Disposisi</td>
    <td class="" colspan="3">No;</td>
  ...
  <tr>
    <td align="center">&nbsp;</td>
    <td class="left" colspan="5">&nbsp;</td>
    <td class="" colspan="2" align="right">Dibayar Secara : <img src="{{public_path().'\\pic\\nonchkbox.png'}}" width="15px"></td>
    <td class="right" colspan="3">TUNAI</td>
  </tr>
  <tr>
    <td align="center">&nbsp;</td>
    <td class="left" colspan="5">&nbsp;</td>
    <td class="" colspan="2" align="right"><img src="{{public_path().'\\pic\\chkbox.png'}}" width="15px"></td>
  ...
  <tr>
    ...
    <td class="right" colspan="9"><img src="{{public_path().'\\pic\\nonchkbox.png'}}" width="15px" /> ..................................................................</td>
  </tr>
  <tr>
    <td align="center">&nbsp;</td>
    <td class="left">&nbsp;</td>
  ...
  <tr>
    ...
    <td class="top right" colspan="7"><img src="{{public_path().'\\pic\\nonchkbox.png'}}" alt="" width="15px" /> Form Tambahan Anggaran</td>
  </tr>
  <tr>
    <td align="center">&nbsp;</td>
    <td colspan="3" class="left">&nbsp;</td>
    <td class="right" colspan="7"><img src="{{public_path().'\\pic\\nonchkbox.png'}}" alt="" width="15px" /> Form Subtitusi Anggaran</td>
  </tr>
  <tr>
    <td align="center">&nbsp;</td>
    <td class="left" colspan="7">&nbsp;</td>
    ...
    <td  class="left right top" colspan="10">
      <table>
        <tr>
          ...
          <td><img src="{{public_path().'\\pic\\nonchkbox.png'}}" alt="" width="15px" /> PPh 21;tarif………..%</td>
          <td><img src="{{public_path().'\\pic\\nonchkbox.png'}}" alt="" width="15px" /> PPh 23;tarif………..%</td>
          <td><img src="{{public_path().'\\pic\\nonchkbox.png'}}" alt="" width="15px" /> lain;Pajak………..;tarif………..%</td>
        </tr>
      </table>
    </td>
  </tr>
  ...
  <tr>
    ...
    <td class="" colspan="2" width="15"><img src="{{public_path().'\\pic\\nonchkbox.png'}}" width="15px"> OP</td>
  ...
  <tr>
    <td align="center">&nbsp;</td>
    <td class="left">&nbsp;</td>
    <td class="" colspan="2"><img src="{{public_path().'\\pic\\nonchkbox.png'}}" width="15px"> Badan Usaha</td>
    <td class="" colspan="3">Nama : </td>
    <td class="right" colspan="4">Alamat : </td>
  </tr>
  <tr>
  ...
  <tr>
    <td align="center">&nbsp;</td>
    <td class="left" colspan="3">&nbsp;&nbsp;&nbsp;&nbsp;<img src="{{public_path().'\\pic\\nonchkbox.png'}}" width="15px"> PPh 21, Tarif &nbsp;&nbsp; =………%</td>
  </tr>
  <tr>
    <td align="center">&nbsp;</td>
    <td class="left" colspan="3">&nbsp;&nbsp;&nbsp;&nbsp;<img src="{{public_path().'\\pic\\nonchkbox.png'}}" width="15px"> PPh 23, Tarif &nbsp;&nbsp; =………%</td>
  </tr>
  <tr>
    <td align="center">&nbsp;</td>
    <td class="left" colspan="3">&nbsp;&nbsp;&nbsp;&nbsp;<img src="{{public_path().'\\pic\\nonchkbox.png'}}" width="15px"> PPh 15, Tarif &nbsp;&nbsp; =………%</td>
  </tr>
  <tr>
    <td align="center">&nbsp;</td>
    <td class="left" colspan="3">&nbsp;&nbsp;&nbsp;&nbsp;<img src="{{public_path().'\\pic\\nonchkbox.png'}}" width="15px">&nbsp;<font size="7pt">Psl 4 ayat 2</font>, Tarif =…..….%</td>
  </tr>
  <tr>
    <td align="center">&nbsp;</td>
